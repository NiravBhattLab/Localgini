...
pca_mat =zeros(44*6,numel(model.rxns));
count =1;
for m=1:6
    mem = mems{m};
    for i=1:44
...
save('all_mem/LG_var_rxn_content','explained_var_in_pc1_mem','explained_var_in_pc2_mem','explained_var_in_pc3_mem','explained_var_in_pc1_cl','explained_var_in_pc2_cl','explained_var_in_pc3_cl','explained_var_in_pc1_ct','explained_var_in_pc2_ct','explained_var_in_pc3_ct')