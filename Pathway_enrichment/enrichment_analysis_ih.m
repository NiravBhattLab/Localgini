...
lg_core = core.LG_core_ihuman; %%%%%%%
sd_core = core.SD_core_ihuman;%%%%%%%
lt2_core = core.LT2_core_ihuman;%%%%%%%
load('..\InputData\iHuman.mat')%%%%%%%
tp={};
for i=1:numel(model.rxns)
    tp = [tp;model.subSystems{i}{1}];
end
model.subSystems = tp;
...
save('enrichment_mats_ihuman','enrich_lg','enrich_lt2','enrich_sd')
...
function enrich_mat = getEnrichMat(core,expressionData,model)
    ...
    path_tiss.Pathway(strcmp(path_tiss.Pathway,'Bile acid synthesis'))={'Bile acid biosynthesis'};
    path_tiss.Pathway(strcmp(path_tiss.Pathway,'Glycolysis/gluconeogenesis'))={'Glycolysis / Gluconeogenesis'};
